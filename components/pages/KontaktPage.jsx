              ...
              {!submitted ? (
                ...
                <div style={{ marginTop: 48, padding: 48, border: '1px solid var(--color-line)', background: 'var(--color-muted)' }}>
                  ...
                  <p className="t-lead" style={{ marginTop: 24 }}>
                    Wir haben Ihre Anfrage erhalten und melden uns innerhalb von 24 Stunden. Bei dringenden Anliegen: <a href="tel:+49615151522" style={{ color: 'var(--color-secondary)' }}>06151 151522</a>.
                  </p>
