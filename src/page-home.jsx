    ...
    <div className="page-shell">
      ...
      <section className="hero" aria-label="Headline">
        ...
        <div className="hero-corner-meta">
          <span style={{ fontFamily: "var(--font-mono)", fontSize: 10.5, letterSpacing: "0.22em", textTransform: "uppercase" }}>
            49°52′N · 08°39′E
          </span>
          <span style={{ fontFamily: "var(--font-mono)", fontSize: 10.5, letterSpacing: "0.22em", textTransform: "uppercase" }}>
            14°C · Darmstadt
        ...
        <div className="container">
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1.4fr", gap: "clamp(48px, 8vw, 140px)", alignItems: "start" }}>
            <Reveal>
              ...
              <div style={{ marginTop: 24, fontFamily: "var(--font-mono)", fontSize: 11, letterSpacing: "0.16em", color: "var(--color-ink-faint)" }}>
                01 — EINLEITUNG
              </div>
            </Reveal>
            <div>
              ...
              <Reveal delay={320}>
                <div style={{ marginTop: 56, display: "flex", gap: 24, flexWrap: "wrap" }}>
                  <button className="btn" onClick={() => nav("ueber-uns")}>
                    <span>Unser Haus kennenlernen</span><span className="arrow">→</span>
                  </button>
                  <button className="btn btn-ghost" onClick={() => nav("objekte")}>
                    <span>Aktuelle Objekte</span><span className="arrow">→</span>
                  </button>
                </div>
              </Reveal>
            </div>
      ...
      <section className="section" style={{ position: "relative", overflow: "hidden" }}>
        ...
        <div className="container">
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "end", gap: 32, marginBottom: 64, flexWrap: "wrap" }}>
            <Reveal>
              ...
              <h2 className="t-h1" style={{ marginTop: 24, maxWidth: "16ch" }}>
                Zwei Disziplinen.<br />Eine <em>Haltung</em>.
              </h2>
            </Reveal>
            <Reveal delay={120}>
              <p className="t-lead" style={{ maxWidth: "38ch" }}>
                Wir trennen, was nicht zusammengehört — und verbinden, was sich ergänzt: Verkauf und Verwaltung unter einem Dach, ohne Reibung.
              </p>
            </Reveal>
          </div>
          ...
          <div className="service-grid">
            <Reveal>
              <div className="service-card" onClick={() => nav("verkauf")}>
            ...
            <Reveal delay={120}>
              <div className="service-card" onClick={() => nav("verwaltung")}>
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "start" }}>
        ...
        <div className="container">
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "end", gap: 32, marginBottom: 56, flexWrap: "wrap" }}>
            <Reveal>
              ...
              <h2 className="t-h1" style={{ marginTop: 24 }}>
                Aktuelle <em>Objekte</em>
              </h2>
            </Reveal>
            <Reveal delay={120}>
              <button className="link-line" onClick={() => nav("objekte")}>
                Alle Objekte ansehen <span className="arrow">→</span>
              </button>
            </Reveal>
          </div>
            ...
            <div>
              ...
              <Reveal delay={300}>
                <div style={{ marginTop: 56, display: "grid", gridTemplateColumns: "1fr 1fr", gap: 32, paddingTop: 32, borderTop: "1px solid rgba(255,255,255,0.14)" }}>
                  <div>
                    ...
                    <div style={{ marginTop: 8, fontFamily: "var(--font-mono)", fontSize: 11, letterSpacing: "0.18em", textTransform: "uppercase", color: "rgba(255,255,255,0.6)" }}>
                      Gründung durch<br />Jörn Meenenga
                    </div>
                  </div>
                  <div>
                    <div className="t-num" style={{ color: "var(--color-secondary)" }}>2021</div>
                    <div style={{ marginTop: 8, fontFamily: "var(--font-mono)", fontSize: 11, letterSpacing: "0.18em", textTransform: "uppercase", color: "rgba(255,255,255,0.6)" }}>
                      Eintritt von<br />Michel Meenenga
                    </div>
                  </div>
                </div>
              </Reveal>
              <Reveal delay={400}>
                <div style={{ marginTop: 48 }}>
                  <button className="btn btn-ondark" onClick={() => nav("ueber-uns")}>
                    <span>Über uns</span><span className="arrow">→</span>
                  </button>
                </div>
              </Reveal>
            </div>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1.4fr 0.6fr", gap: 80, alignItems: "end" }}>
            <Reveal delay={120}>
              <p className="pull-quote">
                Wir wurden nicht beraten, wir wurden begleitet. Das ist ein Unterschied, den man erst bemerkt, wenn er nicht da ist.
              </p>
            </Reveal>
            <Reveal delay={240}>
              <div>
                ...
                <div style={{ marginTop: 40, paddingTop: 24, borderTop: "1px solid var(--color-line)" }}>
                  <div style={{ fontFamily: "var(--font-mono)", fontSize: 11, letterSpacing: "0.18em", textTransform: "uppercase", color: "var(--color-ink-faint)" }}>Auswahl Mandate</div>
                  <ul style={{ listStyle: "none", padding: 0, margin: "20px 0 0 0", display: "flex", flexDirection: "column", gap: 10, fontSize: 14, color: "var(--color-ink-soft)" }}>
                    <li>· WEG-Verwaltung Familie K.</li>
                    <li>· Stadtvilla Mathildenhöhe</li>
                    <li>· Anwesen Mühltal</li>
                    <li>· 17 weitere Familienholdings</li>
                  </ul>
                </div>
              </div>
            </Reveal>
          ...
          <div style={{ background: "var(--color-muted)", padding: "clamp(56px, 7vw, 96px)", display: "grid", gridTemplateColumns: "auto 1fr auto", gap: "clamp(32px, 5vw, 80px)", alignItems: "center", flexWrap: "wrap" }}>
            ...
            <Reveal delay={100}>
              <div>
                ...
                <p className="t-body" style={{ marginTop: 24, maxWidth: "58ch" }}>
                  Kein Marketing mit längst vergebenen Immobilien. Kein künstliches Portfolio. Was Sie hier sehen, ist verfügbar — alles andere gehört in die Referenzmappe, nicht ins Schaufenster.
                </p>
              </div>
            </Reveal>
            <Reveal delay={200}>
        ...
        <div className="container">
          <div style={{ background: "var(--color-primary)", color: "var(--color-background)", padding: "clamp(64px, 8vw, 120px) clamp(40px, 6vw, 96px)", display: "grid", gridTemplateColumns: "1.4fr 1fr", gap: 64, alignItems: "center" }}>
            <Reveal>
              ...
              <h2 className="t-h1" style={{ color: "var(--color-background)", marginTop: 24, maxWidth: "16ch" }}>
                Was ist Ihre Immobilie heute <em>wert</em>?
              </h2>
              <p className="t-lead" style={{ marginTop: 32, color: "rgba(255,255,255,0.7)" }}>
                Eine fundierte Einschätzung in 14 Tagen — auf Basis aktueller Vergleichsdaten, regionaler Expertise und persönlicher Besichtigung. Vertraulich. Kostenfrei. Unverbindlich.
              </p>
            </Reveal>
            <Reveal delay={120}>
              <div style={{ display: "flex", flexDirection: "column", gap: 24, alignItems: "flex-start" }}>
                ...
                <a href="tel:+4961512789400" style={{ fontFamily: "var(--font-display)", fontSize: 32, color: "var(--color-secondary)", textDecoration: "none", fontWeight: 400 }}>+49 6151 27 89 40</a>
              </div>
            </Reveal>
          </div>
        </div>
